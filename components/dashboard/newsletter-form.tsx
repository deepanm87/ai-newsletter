      ...
      <Card className="transition-all hover:shadow-lg">
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Select date range, feeds, and add content to generate your AI-powered newsletter
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="border rounded-lg p-4 space-y-3 max-h-60 overflow-y-auto">
              {feeds.map(feed => (
                <div key={feed.id} className="flex items-center space-y-2">
                  <Checkbox 
                    id={feed.id}
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Your instructions will be prioritized and incorporated into the newsletter. Default settings from the settings page will also be applied.
            </p>
          </div>
