      ...
      <div className="container mx-auto py-12 px-6 lg:px-8 space-y-8">
        ...
        <Card className="transition-all hover:shadow-lg border-2 border-blue-600/20 dark:border-blue-500/20">
          <CardHeader>
            ...
            <CardDescription className="text-bass">
              Generated on{" "}
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div className="flex items-start gap-3">
                <div className="inline-flex size-8 items-center justify-center rounded-md bg-linear-to-br from-blue-600 to-purple-600 text-white shrink-0 mt-0.5">
              ...
              <div className="flex items-start gap-3">
                <div className="inline-flex size-8 items-center justify-center rounded-md bg-linear-to-br from-blue-600 to-purple-600 text-white shrink-0 m-0.5">
