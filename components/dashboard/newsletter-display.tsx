...
export function NewsletterDisplay({
  ...
  const downloadNewsletter = () => {
    ...
    toast.success("Newsletter downlaoded!")
  }
        ...
        {newsletter.additionalInfo && (
          <div className="space-y-3 mt-6">
            ...
            <div className="border rounded-lg p-6 prose prose-sm max-w-none dark:prose-invert">
              <div className="animate-in fade-in slide-in-front-left-2 duration-300">
...
function NewsletterSection({
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <Label className={compact ? "text-base font-bold" : "text-lg font-bold"}>
          {title}
        </Label>
        <Button
          variant="ghost"
      ...
      <div className={`border rounded-lg ${compact ? "p-3" : "p-4"} space-y-2 ${compact ? "max-h-[500px] overflow-y-auto" : ""}`}>
        {safeItems.length === 0 ? (
          <div className="space-y-2">
            ...
            {isGenerating && (
              <div className="space-y-2">
                <div className="h-4 bg-muted animate-pulse rounded" />
                <div className="h-4 bg-muted animate-pulse rounded w-4/5" />
                <div className="h-5 bg-muted animate-pulse rounded w-3/5" />
              </div>
            )}
          </div>
        ) : (
          safeItems.map((item, index) => (
            <div
              ...
              className="flex flex-start gap-2 animate-in fade-in slide-in-from-left-2 duration-300"
            >
              <Badge
                variant="outline"
