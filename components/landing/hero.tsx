...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-white to-gray-50 dark:from-black dark:to-gray-950 py-20 sm:py-32">
      <div className="asbolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-5xl font-bold tracking-tight tex-gray-900 dark:text-white sm:text-6xl lg:text-7xl">
        ...
        <div className="relative mx-auto mt-16 max-w-6xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center gap-4 my-6 lg:my-0">
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-br from-blue-600 to-purple-600 shadow-lg">
