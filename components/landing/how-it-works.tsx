...
const steps = [
  {
    ...
    description: "Add up to 3 RSS feeds on starter ($9/month), or unlimited with pro ($19/month). We'll automatically fetch and organize content from all your sources."
  },
  {
    number: "02",
    icon: Calendar,
